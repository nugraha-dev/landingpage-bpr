...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section id="home" class="page_slider">
				<div class="flexslider">
					<img id="slider-image-landscape" src="images/bpr/Banner-Terbaru.webp" alt="img Landscape" draggable="false">
					<img id="slider-image-portrait" src="images/bpr/Banner_portrait.webp" alt="img Portrait" draggable="false">
				</div>
							...
							<form action="{{ route('admin.dashboard.store') }}" method="POST">
								...
								<div class="row c-mb-10 c-gutter-10">
									<p style="line-height: 10px; text-align: center;">
										<span style="font-weight: 400; font-size: 11px; color: rgb(255, 255, 255); background-color: rgba(227, 34, 34, 0); font-style: normal;">
